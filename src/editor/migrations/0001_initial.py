# Generated by Django 3.2.15 on 2022-09-01 14:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='PlaylistTrack',
            fields=[
                ('playlist', models.OneToOneField(db_column='PlaylistId', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='editor.playlist')),
            ],
            options={
